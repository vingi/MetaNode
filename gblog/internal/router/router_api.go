...
import (
	...
	"github.com/xinliangnote/go-gin-api/internal/api/blog"
...
func setApiRouter(r *resource) {
	...
	blogs := r.mux.Group("/api/blog", core.WrapAuthHandler(r.interceptors.CheckLogin), r.interceptors.CheckSignature())
	{
		blogHandler := blog.New(r.logger, r.db, r.cache)
		blogs.POST("/blog/create", blogHandler.Create())
		blogs.POST("/blog/update/:id", blogHandler.Update())
		blogs.POST("/blog/delete/:id", blogHandler.Delete())
		blogs.GET("/blog/:id", blogHandler.Detail())
	}
